...
7. See admin panel at top
8. Checkout a file as admin
9. Login as john (different browser/incognito)
10. Try to checkin admin's file → Disabled button
11. Back to admin: Force checkin john's file → Should work
12. Click "View Audit Logs" → See all actions logged
    **File structure:**
